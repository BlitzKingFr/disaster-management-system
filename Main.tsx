                        ...
                        <div
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div
                                    ...
                                    <span className="material-symbols-outlined text-blue-500 mt-0.5">water_drop</span>
                                    <div className="flex-1">
                                ...
                                <div
                                    ...
                                    <span
                                        className="material-symbols-outlined text-orange-500 mt-0.5">medical_services</span>
                                    <div className="flex-1">
                                ...
                                <div
                                    ...
                                    <span className="material-symbols-outlined text-slate-500 mt-0.5">local_shipping</span>
                                    <div className="flex-1">
                                        <p className="text-slate-900 dark:text-white text-sm font-bold leading-snug">
